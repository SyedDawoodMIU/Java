...
public class Account extends AccountChangeSubject {
	...
	public void deposit(double amount) {
		AccountEntry entry = new AccountEntry.Builder().withDate(new Date()).withAmount(amount)
	...
	public void transferFunds(Account toAccount, double amount, String description) {
		AccountEntry fromEntry = new AccountEntry.Builder().withDate(new Date()).withAmount(-amount)
				.withDescription(description)
				.withFromAccountNumber("" + toAccount.getAccountnumber())
				.withFromPersonName(toAccount.getCustomer().getName())
				.build();
		AccountEntry toEntry = new AccountEntry.Builder().withDate(new Date()).withAmount(amount)
				.withDescription(description)
				.withFromAccountNumber("" + toAccount.getAccountnumber())
				.withFromPersonName(toAccount.getCustomer().getName())
				.build();
