...
public class Application {
	...
	public static void main(String[] args) {
		...
		iterator = customerCollection.getAgeIterator();
		...
		Predicate<Address> chicagoCustomers = address -> address.getCity().equals("Chicago");

		iterator = customerCollection
				.getAddressFilterIterator(chicagoCustomers);
		while (iterator.hasNext()) {
			System.out.println(iterator.next());
		}

		Predicate<Address> zip12Customers = address -> address.getZip().startsWith("12");

		iterator = customerCollection
				.getAddressFilterIterator(zip12Customers);
		while (iterator.hasNext()) {
			System.out.println(iterator.next());
		}
		...
		iterator = customerCollection.getSkipperIterator();
		while (iterator.hasNext()) {
			System.out.println(iterator.next());
		}
	}
